...
class AVHistoryViewListController: VBaseViewController {
    ...
    lazy var tableView: UITableView = {
        ...
        table.bounces = false
        table.register(UINib(nibName: String(describing: VideoHistoryCell.self), bundle: nil), forCellReuseIdentifier: cellIdentifier)
    ...
    private var botView: VideoHistoryBottomView = VideoHistoryBottomView.view()
    ...
    func setUpUI() {
        ...
        navBar.rightBtn.setImage(UIImage(named: "video_his_edit"), for: .normal)
    ...
    override func clickRightAction() {
        ...
        if self.isSelect {
            navBar.rightBtn.setImage(UIImage(named: "video_his_done"), for: .normal)
            ...
            self.botView.clickBlock = { [weak self] index in
                ...
                if index == 1 {
                    ...
                    self.isSelect = false
                    DispatchQueue.main.async {
                        self.navBar.rightBtn.setImage(UIImage(named: "video_his_edit"), for: .normal)
...
extension AVHistoryViewListController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: VideoHistoryCell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier) as! VideoHistoryCell
